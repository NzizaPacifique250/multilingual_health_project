...
> **74% is lexical overlap** → the winning strategy is generating answers in the *correct
> language & script* that *reuse the reference vocabulary*.

## Results so far

| Run | Model | Val ROUGE-1 | Val ROUGE-L | Val proxy* | LB |
|-----|-------|------------:|------------:|-----------:|----|
| B0  | TF-IDF retrieval (CPU, no training) | 0.4212 | 0.3660 | **0.3936** | — |
...
10–50× slower and RAM-bound). Use Kaggle (free T4, 30 h/week) or Colab.
